...
def get_recommendation_map_by_user_id_and_lat_lng (user_id, latitude, longitude):
...
def update_user_recommendation_map (user_id, latitude, longitude, recommendation_map):
    ...
    response = config.recommendations_dynamodb_table.update_item(
        Key={
            ...
            config.recommendations_skey : geohash
        },
        UpdateExpression='SET #attribute = :val',
        ExpressionAttributeNames={
